...
export default function WaiterDashboardPage({ params }: { params: Promise<{ orgId: string }> }) {
  const { orgId } = use(params);
  const { orders, loading, error, fetchOrders, updateOrderStatus } = useOrders(orgId);
